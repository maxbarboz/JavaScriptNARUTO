...
*/
 function isOperatorValid ( operador ){
    ...
    // testando se no meu objeto operation exeiste um operador igual ao que foi passado
...
operationSignal = "+"
var sum = calculador( operationSignal );
...
// ?
operationSignal = "-"
var sub = calculador( operationSignal );
...
operationSignal = "/"
var div = calculador( operationSignal );
...
operationSignal = "%"
var resto = calculador( operationSignal );
...
operationSignal = "*"
var vezes = calculador( operationSignal );

if( vezes ){
    number1 = 10;
    number2 = 20;
    console.log ( showOperationMessage(operationSignal, number1 , number2  ) + vezes ( number1 , number2  ) )
