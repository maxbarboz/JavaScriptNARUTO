...
cpfs.forEach( function( cpfs ){
    return console.log( cleanCPF( cpfs ) )
})
...
cpfs.forEach( function( cpfs ){
    return console.log ( cleanCPF( cpfs ).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/ , "$1.$2.$3-$4"))
})
...
console.log( "<div><section><blockquote>Texto <img /></blockquote></section></div>".match( /<\w+>/gi ))
